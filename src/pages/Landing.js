    ...
    return (
        <Container style={{ backgroundColor: 'white' }}>
            ...
            <AboutSection className='aboutUs'>
                ...
                <AboutText className='aboutTxt'>Your project is a dynamic web application built using React.js, a popular JavaScript library for building user interfaces. The application is primarily focused on providing recipes to users.</AboutText>
